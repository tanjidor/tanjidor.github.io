	...
	if($('#morris_bar_chart').length > 0)
	   // Bar Chart
		Morris.Bar({
			...
			data: [{
				device: 'Surat Pernyataan Hutang',
				geekbench: 136
			}, {
				device: 'Surat Permohonan',
				geekbench: 137
			}, {
				device: 'Surat Kuasa',
				geekbench: 275
			}, {
				device: 'Surat Kuasa Istimewa',
				geekbench: 380
			}, {
				device: 'Berita Acara Mediasi',
				geekbench: 655
			}, {
				device: 'Duplik',
				geekbench: 1571
			...
			{
				device: 'Tanda Terima Pembayaran',
				geekbench: 1571
			},],
			xkey: 'device',
			ykeys: ['geekbench'],
		...
		// $('#morris_bar_chart').resize(function () { bar.redraw(); });
